        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            StreamBuilder<QuerySnapshot>(
              ...
              stream: _store.collection('Courses').doc(widget.courseId).collection("messages").snapshots(),
                  ...
                  FlatButton(
                    onPressed: () async {
                      ...
                      if(message!=""){
                        ...
                        final a=await  _store.collection('Courses').doc(widget.courseId).collection("messages").add({
                          'text':message,
